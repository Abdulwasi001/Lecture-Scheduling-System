<?php
    ...
    if (isset($_POST['addStu'])) {
        ...
        if (mysqli_num_rows($checkID) == 1) {
            header('location:students.php?msg=idex');
        } else if (mysqli_num_rows($checkemail) == 1) {
            header('location:students.php?msg=emailex');
        } else if (mysqli_num_rows($checkcontact) == 1) {
            header('location:students.php?msg=contactex');
        } else {
            $sql = "INSERT INTO users (`role`, acesID, title, fullname, email, contact, pass, `level`) VALUES ('$role', '$acesID', '$title', '$fullname', '$email', '$contact', '$pass', '$level')";
            if ($query_run = mysqli_query($db, $sql)) {
                header('location:students.php?msg=lcad');
            } else {
    ...
    if (isset($_POST['updateStu'])) {
        ...
        $sql = "UPDATE users SET acesID = '$acesID', title = '$title', fullname = '$fullname', email = '$email', contact = '$contact', `level` = '$level' WHERE userID = '$userID' ";
        if ($query_run = mysqli_query($db, $sql)) {
            header('location:students.php?msg=recordup');
        } else {
            echo 'Error'.$sql.'<br>'.$db->error;
        } 
    }
    ...
    if (isset($_GET['del'])) {
        ...
        if (mysqli_query($db, $query)) {
            header('location:students.php?msg=del');
        }
    }
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <main class="col-md-10 ms-sm-auto col-lg-10 px-md-4">
                    ...
                    <button type="button" class="btn btn-dark mb-2" data-bs-toggle="modal" data-bs-target="#add_Record_Modal">Add Student</button>
                            ...
                            <div class="modal-content">
                                <form action="" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <input type="hidden" name="role" value="S" class="form-control" readonly>
                                            <div class="col-12">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" name="addStu" class="btn btn-dark">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive">
                        <div class="text-center"><h5>100 Level Students</h5></div>
                        <table class="table table-bordered table-hover">
                            ...
                            <?php
                                $sn = 1;
                                $query = mysqli_query($db, "SELECT * FROM users WHERE `role` = 'S' AND `level` = '100' ");
                            ...
                            ?>
                                ...
                                <td><?php echo $sn++; ?></td>
                                    ...
                                    <th>
                                        ...
                                        <a href="students.php?del=<?php echo $row['userID']; ?>" onclick="return confirm('Do you want to delete this?')"><i class="fa fa-trash-o"></i> </a></td>
                                    </th>
                                </tr>
                            <?php ?>
                                <!-- EDIT RECORD MODAL-->
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="" method="post">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                                    <button type="submit" name="updateStu" class="btn btn-dark">Update</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                    ...
                    <!-- 200 level list-->
                    <div class="table-responsive">
                        <div class="text-center"><h5>200 Level Students</h5></div>
                        <table class="table table-bordered table-hover">
                            <thead>
                                <th></th>
                                <th>Students ID</th>
                            ...
                            <?php
                                $sn = 1;
                                $query = mysqli_query($db, "SELECT * FROM users WHERE `role` = 'S' AND `level` = '200' ");
                                while ($row = mysqli_fetch_array($query)) {
                            ?>
                                <tr>
                                <td><?php echo $sn++; ?></td>
                    ...
                    <!-- 300 level list-->
                    <div class="table-responsive">
                        <div class="text-center"><h5>300 Level Students</h5></div>
                        <table class="table table-bordered table-hover">
                            <thead>
                                <th></th>
                                <th>Students ID</th>
                            ...
                            <?php
                                $sn = 1;
                                $query = mysqli_query($db, "SELECT * FROM users WHERE `role` = 'S' AND `level` = '300' ");
                                while ($row = mysqli_fetch_array($query)) {
                            ?>
                                <tr>
                                <td><?php echo $sn++; ?></td>
                    ...
                    <!-- 400 level list-->
                    <div class="table-responsive">
                        <div class="text-center"><h5>400 Level Students</h5></div>
                        <table class="table table-bordered table-hover">
                            <thead>
                                <th></th>
                                <th>Students ID</th>
                            ...
                            <?php
                                $sn = 1;
                                $query = mysqli_query($db, "SELECT * FROM users WHERE `role` = 'S' AND `level` = '400' ");
                                while ($row = mysqli_fetch_array($query)) {
                            ?>
                                <tr>
                                <td><?php echo $sn++; ?></td>
